...
| [002: Suite Manager](../tasks/002-suite-manager.md) | Installable Manager with catalog and safe module lifecycle | Task 001 complete; owner assigns Task 002 with documented restart/recovery constraints |
